...
EGIT_REPO_URI="https://github.com/JakeStanger/ironbar"
...
SLOT="0"
KEYWORDS="~amd64"
IUSE="cairo +http +music notifications +tray +volume sway hyprland"
REQUIRED_USE="
"
...
src_configure() {
	...
	local myfeatures=(
		...
		"upower"
		$(usev volume)
		$(usex "hyprland" "workspaces+hyprland" "")
		$(usex "sway" "workspaces+sway" "")
	)
